export const privateBenefits = {
  ...
  header1Span: "APPROACH",
  para1:
    "At Skatefy, we take a personalized approach to every lesson, ensuring that each session is tailored to your unique skill level and goals, so you can achieve your full skateboarding potential.",
  header2: "FAST ",
  header2Span: "PROGRESS",
  para2:
    "With our private lessons at Skatefy, you'll experience the thrill of rapid skill improvement, accelerating your progress on the skateboard faster than you ever thought possible.",
  header3: "FLEXIBLE",
  header3Span: "SCHEDULE",
  para3:
...
export const beyondBeginnerBenefits = {
  ...
  para1:
    "In Beyond Beginner Lessons, you'll explore a diverse range of skateboarding styles and challenges, keeping your sessions fresh and exciting as you expand your repertoire.",
  header2: "CONFIDENCE",
  header2Span: "BUILDING",
  para2:
    "Our Beyond Beginner Lessons focus not only on skill acquisition but also on building your confidence as a skateboarder, enabling you to tackle even the most complex maneuvers with self-assurance.",
  header3: "PERSONALIZED",
  header3Span: "CHALLENGES",
  para3:
